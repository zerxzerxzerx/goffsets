namespace offsets {
	...
	inline constexpr uintptr_t CameraMaxZoomDistance = 0x349;
	inline constexpr uintptr_t CameraMinZoomDistance = 0x354;
	...
	inline constexpr uintptr_t DataModelPrimitiveCount = 0x4a0;
	...
	inline constexpr uintptr_t FakeDataModelPointer = 0x7a39ad8;
	...
	inline constexpr uintptr_t JobsPointer = 0x7fcb088;
	...
	inline constexpr uintptr_t PlayerMouse = 0x1180;
	inline constexpr uintptr_t Position = 0xec;
	inline constexpr uintptr_t Primitive = 0x148;
	inline constexpr uintptr_t PrimitiveValidateValue = 0x6;
	inline constexpr uintptr_t PrimitivesPointer1 = 0x280;
	inline constexpr uintptr_t PrimitivesPointer2 = 0x280;
	...
	inline constexpr uintptr_t TaskSchedulerPointer = 0x7fcb088;
	...
	inline constexpr uintptr_t VisualEngineToDataModel2 = 0xbb0;
