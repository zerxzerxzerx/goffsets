namespace offsets {
	...
	inline constexpr uintptr_t FakeDataModelPointer = 0x78ff228;
	...
	inline constexpr uintptr_t JobsPointer = 0x7e90548;
	...
	inline constexpr uintptr_t TaskSchedulerPointer = 0x7e90548;
