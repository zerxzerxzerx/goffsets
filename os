namespace offsets {
	...
	inline constexpr uintptr_t CameraMaxZoomDistance = 0x360;
	inline constexpr uintptr_t CameraMinZoomDistance = 0x364;
	...
	inline constexpr uintptr_t FakeDataModelPointer = 0x7be9278;
	...
	inline constexpr uintptr_t JobsPointer = 0x8179078;
	...
	inline constexpr uintptr_t MouseSensitivity = 0x7da8a78;
	...
	inline constexpr uintptr_t BeamColor = 0x178;
